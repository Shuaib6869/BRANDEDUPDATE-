...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002040246114"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Shuaib6869/BRANDEDUPDATE-",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/070862ea5994ec73d1350.jpg"
)
PING_IMG_URL = getenv(
